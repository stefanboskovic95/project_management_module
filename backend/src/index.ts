...
import { createProject, getProjectStatuses, getBusinessCategories, getCurrencies, getRegions, getProjects, updateProjectStatus } from './routes/project';
...
router.route('/update_project_status').post(updateProjectStatus);
